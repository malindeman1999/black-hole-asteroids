...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        ...
        type=float,
        default=100.0,
        help="Source A ring radius in units of rs (default: 100).",
    )
...
def main() -> None:
    ...
    np.savez_compressed(
        ...
        a_radius_rs=np.asarray(float(args.a_radius_rs), dtype=float),
        sky_radius_rs=np.asarray(float(args.a_radius_rs), dtype=float),
